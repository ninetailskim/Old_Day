...
<%
	...
	String sql = "select * from UserInfo,ClassStu where UserInfo.userName='" + loginname +"' and ClassStu.cid = " + cid;
	...
	if (rs.next())
			rs.deleteRow();
		sql = "select * from ClassStu,UserInfo,ClassInfo where UserInfo.userName='" + loginname +"' and UserInfo.userId = ClassStu.sid and ClassInfo.classId = ClassStu.cid";
