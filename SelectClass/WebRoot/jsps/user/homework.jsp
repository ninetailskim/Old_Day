	...
	<table class="tableCommon" id = 'publishid'>
    	...
    	{%>
    		<%while (usercla.next()) {
				...
				{
					out.println("<tr>");
					out.print("<td> "+ homet.getString("hwName") + "<a href='hwupload.jsp?classId="+ usercla.getString("classId") + "&loginname=" + loginname + "&hwId="+ homet.getString("hwId") +"'>上传作业</a></td>");
					out.println("</tr>");
				}
				}
				homet.beforeFirst();
    	...
    	{%>
    		<%while (usercla.next()) {
				...
				{
					out.println("<tr>");
					out.print("<td> "+ homet.getString("hwName") + "<a href='hwupload.jsp?classId="+ usercla.getString("classId") + "&loginname=" + loginname + "&hwId="+ homet.getString("hwId") +"'>上传作业</a> <a href='hwdef.jsp?classId="+ usercla.getString("classId") + "&loginname=" + loginname + "'>批改作业(未实现)</a></td>");
					out.println("</tr>");
				}
				}
				homet.beforeFirst();
