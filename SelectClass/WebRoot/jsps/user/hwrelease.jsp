...
<html>
  ...
  <body>
  <center>
  <form action="<c:url value='/UserServlet'/>" method = "post" id = "releaseForm">
			<input type="hidden" name="method" value ="hwrelease" />
  <table class="tableCommon">
    <%while (rs.next()) {
    			out.print("<tr>");
				out.print("<td class='tdDataCenter'>课程名："
				...
				out.println("</tr>");
				out.print("<tr>");
				out.print("<td><input type='text' name = 'hwname' id = 'hwname' class = 'hwname' /></td>");
				out.println("</tr>");
				out.print("<tr>");
